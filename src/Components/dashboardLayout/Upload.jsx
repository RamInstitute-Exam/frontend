...
export default function ManualExamUploadWizard() {
  ...
  const handleSubOptionChange = (index, key, value) => {
    const updated = [...questions];
    updated[index].subOptions[key] = value;
    setQuestions(updated);
  };
...
const handleSubmit = async () => {
  ...
  // Note: Sub-options are optional for GK questions
  ...
  if (invalidQuestions.length > 0) {
    toast.error(`Please complete all required fields for question ${invalidQuestions[0].questionNumber || '1'}`);
    return;
  }
  ...
  try {
    await batchAPI.manualUpload({
      ...
      generalKnowledgeQuestions: filledQuestions,
...
const renderQuestionForm = (q, i) => (
    ...
    <div className="p-8 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          ...
          <input
            type="number"
            className="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-purple-500 outline-none transition-all duration-200 bg-white hover:border-gray-400"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {["i", "ii", "iii", "iv"].map((opt) => (
          <div key={opt}>
            <label className="block text-sm font-semibold text-gray-700 mb-2">Sub-option {opt}</label>
            <input
              type="text"
              className="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-purple-500 outline-none transition-all duration-200 bg-white hover:border-gray-400"
              value={q.subOptions?.[opt] || ""}
              onChange={(e) => handleSubOptionChange(i, opt, e.target.value)}
              placeholder={`Enter sub-option ${opt}`}
            />
          </div>
        ))}
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div>
          ...
          <select
            className="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-purple-500 outline-none transition-all duration-200 bg-white hover:border-gray-400 cursor-pointer"
  ...
  return (
    <div className="space-y-6 pb-8">
      {/* Header */}
      <div className="bg-gradient-to-r from-purple-600 to-purple-700 rounded-2xl shadow-lg border border-purple-500/20 p-8 text-white">
        <div className="flex items-center gap-4">
          <div className="p-4 bg-white/20 backdrop-blur-sm rounded-xl">
            <BookOpen className="w-8 h-8" />
          </div>
          <div>
            <h1 className="text-3xl font-bold">General Knowledge Question Upload</h1>
            <p className="text-purple-100 mt-2 text-base">Create and upload GK exam questions manually</p>
          </div>
        </div>
      </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                ...
                <div>
                  ...
                  <input 
                    ...
                    placeholder="e.g., GK001, TNPSC-GK-2025"
                  />
                  <p className="text-xs text-gray-500 mt-1 flex items-center gap-1">
                    <HelpCircle className="w-3 h-3" />
                ...
                <div className="md:col-span-2">
                  ...
                  <input 
                    ...
                    placeholder="e.g., TNPSC Group I - General Knowledge"
                  />
                  <p className="text-xs text-gray-500 mt-1 flex items-center gap-1">
                    <HelpCircle className="w-3 h-3" />
                ...
                <div className="md:col-span-2">
                  ...
                  <textarea 
                    className="w-full px-4 py-3 border-2 border-gray-300 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-purple-500 outline-none transition-all duration-200 bg-white hover:border-gray-400 resize-none" 
                    rows={3}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                <div>
                  ...
                  >
                    ...
                    <option value="GK">General Knowledge Question</option>
                  </select>
                  <p className="text-xs text-gray-500 mt-1 flex items-center gap-1">
                    <HelpCircle className="w-3 h-3" />
                ...
                <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-5 border-2 border-blue-200">
                  <label className="flex items-start gap-3 cursor-pointer">
                    <input
                      ...
                      className="w-5 h-5 text-purple-600 border-2 border-gray-300 rounded focus:ring-2 focus:ring-purple-500 cursor-pointer mt-0.5"
                    />
                      ...
                      {allowMultipleAttempts && (
                        <div className="mt-4 bg-white rounded-lg p-4 border border-blue-200">
                          ...
                          <input 
                            type="number" 
                            min="1"
                            className="w-full max-w-xs px-4 py-2 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 outline-none transition-all duration-200 bg-white" 
                            value={maxAttempts} 
              ...
              {questions.map((q, i) => (
                <div key={i} className="border-2 border-gray-200 rounded-xl p-6 hover:shadow-lg transition-all duration-200 bg-gradient-to-br from-white to-gray-50">
                  <div className="flex items-center justify-between mb-4 pb-4 border-b border-gray-200">
                    ...
                    <span className="px-4 py-2 text-sm font-semibold bg-gradient-to-r from-purple-100 to-purple-200 text-purple-800 rounded-xl">
                      {q.questionType || 'MCQ'}
                    </span>
                  </div>
